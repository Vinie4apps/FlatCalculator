package com.vinie4apps.flatcalculator;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnTouchListener
{
    ...
    private boolean addOperand(String operand)
    {
        ...
        {
            Toast.makeText(getApplicationContext(), R.string.ex, Toast.LENGTH_LONG).show();
        }
        return done;
    }
    ...
    private void calculate(String input)
    {
        ...
        {
            Toast.makeText(getApplicationContext(), R.string.re, Toast.LENGTH_SHORT).show();
            return;
        }

        if (result.equals(getString(R.string.fd)))
        {
            Toast.makeText(getApplicationContext(), R.string.fffff, Toast.LENGTH_SHORT).show();
